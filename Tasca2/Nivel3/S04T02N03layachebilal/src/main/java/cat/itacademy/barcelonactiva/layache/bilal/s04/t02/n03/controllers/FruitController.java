package cat.itacademy.barcelonactiva.layache.bilal.s04.t02.n03.controllers;

import cat.itacademy.barcelonactiva.layache.bilal.s04.t02.n03.model.domain.Fruit;
import cat.itacademy.barcelonactiva.layache.bilal.s04.t02.n03.model.services.FruitService;
...
public class FruitController {
    ...
    public ResponseEntity<String> deleteFruit(@PathVariable String fruitId){
        fruitService.deleteFruit(fruitId);
        return ResponseEntity.ok("Eliminat");
    }

    @GetMapping("/getOne/{fruitId}")
    public ResponseEntity<Optional<Fruit>> getById(@PathVariable String fruitId) {
